...
#Templating by Lungsi 2010 based on ~/PCDCNnMFDCN2015bSudhakar/model2.hoc
#model2.hoc has been converted from the original DCN_init_model2.hoc
#model2.hoc does not authomatically start the simulation and start recording.
