# ~/models/cells/modelCFPC2019AitOuares.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "CFPC2019AitOuares" + os.sep # record path to this model/folder

from models.cells.CFPC2019AitOuares.ClimbingPurkinje import ClimbingPurkinje
...
class ClimbingFiberPurkinjeCell( sciunit.Model,
