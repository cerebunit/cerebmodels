# ~/models/synapses/modelCFPCnPFPC2018Zang.py NOTE: very sensitive to dt, use dt = 0.02
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "synapses" + os.sep + \
                "CFPCnPFPC2018Zang" + os.sep # record path to this model/folder

from models.synapses.CFPCnPFPC2018Zang.CFPFtoPurkinje import CFPFtoPurkinje
...
class ClimbingAndParallelPurkinjeCell( sciunit.Model,
