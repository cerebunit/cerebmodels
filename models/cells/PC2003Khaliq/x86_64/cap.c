...
#define nrn_init _nrn_init__cap
#define _nrn_initial _nrn_initial__cap
#define nrn_cur _nrn_cur__cap
#define _nrn_current _nrn_current__cap
#define nrn_jacob _nrn_jacob__cap
#define nrn_state _nrn_state__cap
#define _net_receive _net_receive__cap 
#define rates rates__cap 
#define states states__cap 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cap", _hoc_setdata,
 "ghk_cap", _hoc_ghk,
 "mtau_func_cap", _hoc_mtau_func,
 "rates_cap", _hoc_rates,
 0, 0
};
#define ghk ghk_cap
#define mtau_func mtau_func_cap
 extern double ghk( double , double , double , double );
 extern double mtau_func( double );
 /* declare global and static user variables */
#define monovalPerm monovalPerm_cap
 double monovalPerm = 0;
#define monovalConc monovalConc_cap
 double monovalConc = 140;
#define mtau mtau_cap
 double mtau = 0;
#define minf minf_cap
 double minf = 0;
 ...
 "monovalConc_cap", &monovalConc_cap,
 "monovalPerm_cap", &monovalPerm_cap,
 "minf_cap", &minf_cap,
 "mtau_cap", &mtau_cap,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cap /home/cereb/cerebmodels/models/cells/PC2003Khaliq/mod_files/cap.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 49 in file cap.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/cereb/cerebmodels/models/cells/PC2003Khaliq/mod_files/cap.mod";
static const char* nmodl_file_text = 
