...
#Templating by Lungsi 2010 based on ~/PCDCNnMFDCN2015cSudhakar/model3.hoc
#model3.hoc has been converted from the original DCN_init_model3.hoc
#model3.hoc does not authomatically start the simulation and start recording.
