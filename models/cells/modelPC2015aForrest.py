# ~/models/cells/modelPC2015aForrest.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "PC2015aForrest" + os.sep # record path to this model/folder

from models.cells.PC2015aForrest.Purkinje import Purkinje
...
class PurkinjeCell( sciunit.Model,
    ...
    def __init__(self):
        ...
        self.description = "Forrest 2015 model of PurkinjeCell (PC) and published in 10.1186/s12868-015-0162-6 This is a multi-compartment (1088) model. This model is the SciUnit wrapped version of the NEURON model in modelDB accession # 180789."
        #
