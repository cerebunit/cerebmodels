# Template of the Regular Firing Granule cell model (multi-compartment), Masoli et al. 2020
# Templating by Lungsi 2022 based on ~/GrC2020aMasoli/Cereb_GrC_regular.py and
# ~/GrC2020aMasoli/protocols/01_currents_injection.py
from neuron import h
from Syntype import Synapse_py3


class GranuleRegular(object):
