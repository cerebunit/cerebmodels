COMMENT
This is a custom mod file that creates an overall ramp for different current amplitudes; not just steps of different amplitudes. For Purkinje Cell PC2015Masoli this is specifically used for running the quasilinear test. As per Stefano Masoli's experience the quasilinear behavior seen in biological Purkinje cells is reproducible in PC2015Masoli model when injection of varying amplitudes is given as ramps (not as steps).
