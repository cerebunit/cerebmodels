# ~/models/cells/modelGrC2011Souza.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "GrC2011Souza" + os.sep # record path to this model/folder

from models.cells.GrC2011Souza.Granule import Granule
...
class GranuleCell( sciunit.Model,
    ...
    def __init__(self):
        ...
        self.description = "Souza & Schutter 2011 model of GranuleCell (GrC) and published in 10.1186/2042-1001-1-7 This is a single compartment model; it is a modification of Diwakar et al. 2009 multicompartment model. It was used as the component for GoC in the network the authors constructed. This model is the SciUnit wrapped version of the NEURON model in modelDB accession # 139656."
        #
