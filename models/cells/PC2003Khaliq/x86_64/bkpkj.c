...
#define nrn_init _nrn_init__bkpkj
#define _nrn_initial _nrn_initial__bkpkj
#define nrn_cur _nrn_cur__bkpkj
#define _nrn_current _nrn_current__bkpkj
#define nrn_jacob _nrn_jacob__bkpkj
#define nrn_state _nrn_state__bkpkj
#define _net_receive _net_receive__bkpkj 
#define rates rates__bkpkj 
#define states states__bkpkj 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 bkpkj /home/cereb/cerebmodels/models/cells/PC2003Khaliq/mod_files/bkpkj.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 66 in file bkpkj.mod:\n           SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/cereb/cerebmodels/models/cells/PC2003Khaliq/mod_files/bkpkj.mod";
static const char* nmodl_file_text = 
