...
from pathspawner import PathSpawner as ps
...
class PathSpawnerTest(unittest.TestCase):
    ...
    def test_1_hatch_path_to_nmodl(self):
        mod_path, lib_path = ps.hatch_path_to_nmodl(modelscale="cells",
    ...
    def test_2_exception_hatch_path_to_nmodl(self):
        self.assertRaises(ValueError, ps.hatch_path_to_nmodl, )
 
    #@unittest.skip("reason for skipping")
    def test_3_hatch_path_to_response(self):
        response_path = ps.hatch_path_to_response(modelscale="cells",
                                                  modelname="XY2000Author")
        self.assertEqual(
    ...
    def test_4_exception_hatch_path_to_response(self):
        self.assertRaises(ValueError, ps.hatch_path_to_response, )
