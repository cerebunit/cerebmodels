# ~/models/cells/modelPC2015bForrest.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "PC2015bForrest" + os.sep # record path to this model/folder

from models.cells.PC2015bForrest.Purkinje import Purkinje
...
class PurkinjeCell( sciunit.Model,
    ...
    def produce_soma_spikeheight_antidromic(self, **kwargs):
        return self.produce_spikeheight("dend v", **kwargs)
