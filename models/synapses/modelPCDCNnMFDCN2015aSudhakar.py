# ~/models/cells/modelPCDCNnMFDCN2015aSudhakar.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "PCDCNnMFDCN2015aSudhakar" + os.sep # record path to this model/folder

from models.cells.PCDCNnMFDCN2015aSudhakar.PurkinjeAndMossyToDeepCerebellar \
