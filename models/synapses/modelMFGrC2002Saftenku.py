# ~/models/cells/modelMFGrC2002Saftenku.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "MFGrC2002Saftenku" + os.sep # record path to this model/folder

from models.cells.MFGrC2002Saftenku.MossyGranule import MossyGranule
...
class MossyFiberGranuleCell( sciunit.Model,
    ...
    def __init__(self):
        ...
        self.modelname = "MGGrC2002Saftenku"
        # ------specify cell-regions from with response are recorded-------
        self.regions = {"cell": 0.0}
        # -----------attributed inheritance from sciunit.Model--------------
        self.name = "Saftenku 2002 model of 4 Mossy fiber to 1 Granule cell soma"
        self.description = "Saftenku 2002 model of four MossyFibers (MF) to a GranuleCell (GrC) and published in 10.1023/A:1020723921430 This is the single compartment (soma) GrC to 4 MF. This model is the SciUnit wrapped version of the NEURON model in modelDB accession # 51196."
        #
