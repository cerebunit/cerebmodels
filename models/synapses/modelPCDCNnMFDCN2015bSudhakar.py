# ~/models/cells/modelPCDCNnMFDCN2015bSudhakar.py
import os
pwd = os.getcwd() # record root directory path ~/cerebmodels
path_to_files = pwd + os.sep + "models" + os.sep + "cells" + os.sep + \
                "PCDCNnMFDCN2015bSudhakar" + os.sep # record path to this model/folder

from models.cells.PCDCNnMFDCN2015bSudhakar.PurkinjeAndMossyToDeepCerebellar \
